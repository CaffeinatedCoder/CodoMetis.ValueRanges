...
public class RangeOverlapsTests
{
    ...
    public void Overlaps_Finite_OverlappingRanges_ReturnsTrue()
    {
        ...
        var r2 = Int32Range.Closed(4, 10, true, true); // [4, 10]
    ...
    {
        var r1 = Int32Range.Closed(1, 5,  true, true); // [1, 5]
        var r2 = Int32Range.Closed(5, 10, true, true); // [5, 10]
    ...
    {
        var empty  = Int32Range.EmptyRange();
        var finite = Int32Range.Closed(1, 10);
    ...
    public void Overlaps_OpenStart_FiniteOverlapping_ReturnsTrue()
    {
        ...
        var finite    = Int32Range.Closed(4, 10);          // [4, 10)
    ...
    public void Overlaps_OpenEnd_FiniteOverlapping_ReturnsTrue()
    {
        ...
        var finite  = Int32Range.Closed(1, 8);         // [1, 8)
    ...
    public void Overlaps_TwoOpenStart_AlwaysTrue()
    {
        ...
        var s2 = Int32Range.WithOpenStart(20, false);
    ...
    {
        var e1 = Int32Range.WithOpenEnd(1,  true);
        var e2 = Int32Range.WithOpenEnd(20, false);
