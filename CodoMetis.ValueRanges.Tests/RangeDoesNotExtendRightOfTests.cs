...
public class RangeDoesNotExtendRightOfTests
{
    ...
    public void DoesNotExtendRightOf_ReceiverEndsClearlyShorter_ReturnsTrue()
    {
        ...
        var left  = Int32Range.Closed(1,  20, true, false); // [1, 20)
        var right = Int32Range.Closed(18, 20, true, false); // [18, 20)
    ...
    public void DoesNotExtendRightOf_SameUpperBound_BothInclusive_ReturnsTrue()
    {
        ...
        var left  = Int32Range.Closed(1, 10, true, true);
        var right = Int32Range.Closed(5, 10, true, true);
    ...
    public void DoesNotExtendRightOf_SameUpperBound_ReceiverInclusiveOtherExclusive_ReturnsFalse()
    {
        ...
        var left  = Int32Range.Closed(1, 10, true, true);  // [1, 10]
        var right = Int32Range.Closed(5, 10, true, false); // [5, 10)
    ...
    public void DoesNotExtendRightOf_SameUpperBound_BothExclusive_ReturnsTrue()
    {
        ...
        var left  = Int32Range.Closed(1, 10, true, false);
        var right = Int32Range.Closed(5, 10, true, false);
    ...
    {
        var left  = Int32Range.Closed(1, 15, true, true);
        var right = Int32Range.Closed(5, 10, true, true);
    ...
    public void DoesNotExtendRightOf_OpenEnd_AlwaysReturnsFalse()
    {
        ...
        var finite  = Int32Range.Closed(1, 100, true, true);
    ...
    public void DoesNotExtendRightOf_FiniteVsOpenEnd_ReturnsTrue()
    {
        ...
        var finite  = Int32Range.Closed(1, 100, true, true);
        var openEnd = Int32Range.WithOpenEnd(1, true);
    ...
    public void DoesNotExtendRightOf_OpenStartVsOpenStart_SameBound_BothInclusive_ReturnsTrue()
    {
        ...
        var left  = Int32Range.WithOpenStart(10, true);
        var right = Int32Range.WithOpenStart(10, true);
    ...
    {
        // (-∞, 15] &< (-∞, 10] → false
        var left  = Int32Range.WithOpenStart(15, true);
        var right = Int32Range.WithOpenStart(10, true);
