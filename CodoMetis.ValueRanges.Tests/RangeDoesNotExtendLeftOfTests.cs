...
public class RangeDoesNotExtendLeftOfTests
{
    ...
    public void DoesNotExtendLeftOf_ReceiverStartsClearlyLater_ReturnsTrue()
    {
        ...
        var left  = Int32Range.Closed(7, 20, true, false); // [7, 20)
    ...
    public void DoesNotExtendLeftOf_SameLowerBound_BothInclusive_ReturnsTrue()
    {
        ...
        var left  = Int32Range.Closed(5, 20, true, true);
    ...
    public void DoesNotExtendLeftOf_SameLowerBound_ReceiverInclusiveOtherExclusive_ReturnsFalse()
    {
        ...
        var left  = Int32Range.Closed(5, 20, true,  true); // [5, 20]
    ...
    public void DoesNotExtendLeftOf_SameLowerBound_BothExclusive_ReturnsTrue()
    {
        ...
        var left  = Int32Range.Closed(5, 20, false, true);
        var right = Int32Range.Closed(5, 10, false, true);
    ...
    {
        var left  = Int32Range.Closed(1, 20, true, true);
        var right = Int32Range.Closed(5, 10, true, true);
    ...
    public void DoesNotExtendLeftOf_OpenStart_AlwaysReturnsFalse()
    {
        ...
        var openStart = Int32Range.WithOpenStart(10, true);
        var finite    = Int32Range.Closed(1, 5, true, true);
    ...
    public void DoesNotExtendLeftOf_FiniteVsOpenStart_ReturnsTrue()
    {
        ...
        var finite    = Int32Range.Closed(1, 10, true, true);
        var openStart = Int32Range.WithOpenStart(10, true);
    ...
    public void DoesNotExtendLeftOf_OpenEndVsOpenEnd_SameBound_BothInclusive_ReturnsTrue()
    {
        ...
        var left  = Int32Range.WithOpenEnd(5, true);
        var right = Int32Range.WithOpenEnd(5, true);
    ...
    {
        // [1, +∞) &> [5, +∞) → false
        var left  = Int32Range.WithOpenEnd(1, true);
        var right = Int32Range.WithOpenEnd(5, true);
