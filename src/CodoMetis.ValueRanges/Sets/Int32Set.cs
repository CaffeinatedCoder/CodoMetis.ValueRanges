    ...
    where TElement : struct, IEquatable<TElement>, IComparable<TElement>, IFormattable, IParsable<TElement>
{
    ...
    /// </summary>
    static JsonConverter<TElement>? IValueSetFactory<Int32Set<TElement>, TElement>.ElementJsonConverter
        => ValueSetIntegerElementJsonConverter<Int32Set<TElement>, TElement>.Instance;
